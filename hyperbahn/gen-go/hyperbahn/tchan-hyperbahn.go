...
func newTChanHyperbahnClient(thriftService string, client thrift.TChanClient) *tchanHyperbahnClient {
...
func NewTChanHyperbahnClient(client thrift.TChanClient) TChanHyperbahn {
	return newTChanHyperbahnClient("Hyperbahn", client)
}
...
func newTChanHyperbahnServer(handler TChanHyperbahn) *tchanHyperbahnServer {
...
func NewTChanHyperbahnServer(handler TChanHyperbahn) thrift.TChanServer {
	return newTChanHyperbahnServer(handler)
}
